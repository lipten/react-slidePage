...
/******/ 	__webpack_require__.p = "/example/bundles/";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.initPage = 1;
	    _this.state = {
	      list: [{ name: 'Page1 - 自定义动画', class: 'page1', hasStep: true }, { name: 'Page2 - 定制分页', class: 'page2', hasTips: true }, { name: 'Page3 - 侦测内容长度滚动', class: 'page3', hasList: true }, { name: 'Page4 - 动态添加page', class: 'page1', isAdd: true }],
	      curPage: _this.initPage
	    };
	    return _this;
	  }
	  ...
	  _createClass(App, [{
	    key: 'onBefore',
	    value: function onBefore(origin, direction, target) {
	    ...
	    value: function addPage() {
	      ...
	      this.setState({ list: list }, function () {
	        _this2.refs['SlideContainer'].update();
	      });
	    }
	  }, {
	    key: 'removePage',
	    value: function removePage() {
	      var _this3 = this;
	      ...
	      this.setState({
	        ...
	        _this3.refs['SlideContainer'].update();
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { id: _index2.default['custom-slidePage'] },
	        _react2.default.createElement(
	          _lib.SlideContainer,
	          { page: this.initPage, ref: 'SlideContainer', before: this.onBefore.bind(this) },
	          list.map(function (item, index) {
	            return _react2.default.createElement(
	              _lib.SlidePage,
	              { className: (0, _classnames2.default)(_index2.default['slide-page'], _index2.default[item.class]), key: index },
	              _react2.default.createElement(
	                'h2',
	                null,
	                item.name
	              ),
	              item.hasStep && _react2.default.createElement('div', { className: (0, _classnames2.default)('step', _index2.default['step1'], _index2.default['flash']), 'data-delay': '1000' }),
	              item.hasStep && _react2.default.createElement('div', { className: (0, _classnames2.default)('step', _index2.default['step2'], _index2.default['fadeIn']), 'data-delay': '500' }),
	              item.hasTips && _react2.default.createElement(
	                'p',
	                { className: _index2.default['middle'] },
	                '\u901A\u8FC7before\u4E8B\u4EF6\u548CslideTo\u65B9\u6CD5',
	              ...
	              item.hasTips && _react2.default.createElement(
	                ...
	                '\u901A\u8FC7\u5F00\u653E\u7684\u4E8B\u4EF6\u63A5\u53E3\u548C\u65B9\u6CD5\u53EF\u4EE5\u5B9E\u73B0\u5F88\u591A\u5B9A\u5236\u529F\u80FD'
	              ),
	              item.hasList && _react2.default.createElement(
	                'ul',
	                null,
	                _react2.default.createElement(
	                  'li',
	              ...
	              item.isAdd && _react2.default.createElement(
	                'button',
	                { className: _index2.default['add'], onClick: _this4.addPage.bind(_this4) },
	                '\u6DFB\u52A0page'
	              ),
	              item.isRemove && _react2.default.createElement(
	                'button',
	                { className: _index2.default['remove'], onClick: _this4.removePage.bind(_this4, index) },
	                '\u5220\u9664page'
	              )
	            );
	          })
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: _index2.default['prev-page'], onClick: this.prevPage.bind(this) },
	            '\u039B'
	          ),
	          list.map(function (item, index) {
	            return _react2.default.createElement('a', { key: index,
	              onClick: _this4.slideTo.bind(_this4, index + 1),
	              className: (0, _classnames2.default)(_defineProperty({}, _index2.default['active'], curPage === index + 1)) });
	          }),
	          _react2.default.createElement(
	            'div',
	            { className: _index2.default['next-page'], onClick: this.nextPage.bind(this) },
	            'V'
	          )
	        )
	      );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#index__custom-slidePage___2PbMu {\n  height: 100%;\n}\nul {\n  list-style: none;\n}\n.index__container___1xKnV {\n  display: block;\n}\n\n/* 自定义动画 */\n@keyframes index__flash___1_26Y {\n  from, 50%, to {\n    opacity: 1;\n  }\n\n  25%, 75% {\n    opacity: 0;\n  }\n}\n\n.index__flash___1_26Y {\n  animation: index__flash___1_26Y .5s;\n}\n\n@keyframes index__fadeIn___3PnwS {\n  from {\n    opacity: 0;\n  }\n\n  to {\n    opacity: 1;\n  }\n}\n\n.index__fadeIn___3PnwS {\n  animation: index__fadeIn___3PnwS .5s;\n}\n\n\n.index__slide-page___BS2dA ul {\n  margin: 0;\n  padding: 0;\n  width: 90%;\n  margin-left: 5%;\n}\n\n.index__slide-page___BS2dA ul li {\n  width: 100%;\n  padding: 100px 10px;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  box-sizing: border-box;\n  border-bottom: 1px solid rgb(83, 83, 83);\n  background: rgba(255, 255, 255, .5);\n  text-align: center;\n}\n\n.index__slide-page___BS2dA h2 {\n  margin: 0;\n  padding: 20px 0;\n  text-align: center;\n}\n.index__prev-page___1q7Dr,\n.index__next-page___3RwcX {\n  display: block;\n  width: 25px;\n  height: 25px;\n  line-height: 26px;\n  position: absolute;\n  right: 2px;\n  z-index: 9999;\n  background: rgba(255, 255, 255, .5);\n  border-radius: 50%;\n  font-size: 14px;\n  color: #666;\n  text-align: center;\n}\n\n.index__prev-page___1q7Dr {\n  top: 0;\n}\n\n.index__next-page___3RwcX {\n  bottom: 0;\n}\n\n.index__prev-page___1q7Dr:active {\n  background: rgba(155, 155, 155, .5);\n}\n\n.index__next-page___3RwcX:active {\n  background: rgba(155, 155, 155, .5);\n}\n\n.index__pagination___2NIVW {\n  width: 30px;\n  height: auto;\n  position: fixed;\n  top: 50%;\n  right: 5px;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  box-sizing: border-box;\n  padding: 40px 0;\n  z-index: 1;\n  transform: translate(0, -50%);\n}\n\n.index__pagination___2NIVW a {\n  width: 25px;\n  height: 25px;\n  display: block;\n  line-height: 28px;\n  text-align: center;\n  padding-left: 3px;\n  cursor: pointer;\n}\n\n.index__pagination___2NIVW a:after {\n  content: \"\";\n  width: 15px;\n  height: 15px;\n  border-radius: 50%;\n  display: inline-block;\n  background: rgba(0, 0, 0, .5);\n  -webkit-transition: background .3s ease;\n  -moz-transition: background .3s ease;\n  -ms-transition: background .3s ease;\n  -o-transition: background .3s ease;\n  transition: background .3s ease;\n}\n\n.index__slide-page___BS2dA p.index__middle___3AT6u {\n  position: absolute;\n  top: 50%;\n  transform: translate(0, -50%);\n  text-align: center;\n  width: 100%;\n  margin-top: -20px;\n}\n\n.index__slide-page___BS2dA p.index__tips___AqVy_ {\n  font-size: 14px;\n  color: rgba(68, 68, 68, 0.089);\n  position: absolute;\n  bottom: 0;\n  width: 100%;\n  text-align: center;\n}\n\n.index__pagination___2NIVW a.index__active___2_dK4:after {\n  background: rgba(255, 255, 255, .5);\n}\n\n.index__add___1jL8h,.index__remove___2EGwI{\n  display: block;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  margin-top: -20px;\n  margin-left: -50px;\n  padding: 38px 0;\n  box-sizing: border-box;\n  width: 100px;\n  height: 100px;\n  webkit-border-radius: 50%;\n  -moz-border-radius: 50%;\n  border-radius: 50%;\n  background-color: rgb(47, 95, 178);\n  color: #fff;\n  text-align: center;\n  font-size: 14px;\n  text-decoration: none;\n}\n\n.index__add___1jL8h:hover {\n  background-color: rgb(57, 123, 219);\n}\n\n.index__add___1jL8h:active {\n  background-color: rgb(31, 79, 134);\n}\n\n.index__remove___2EGwI {\n  background-color: rgb(151, 43, 43);\n}\n\n.index__remove___2EGwI:hover {\n  background-color: rgb(194, 63, 63);\n}\n\n.index__remove___2EGwI:active {\n  background-color: rgb(116, 33, 33);\n}\n.index__page1___2YmIi {\n  background-color: #99CC33;\n}\n.index__page1___2YmIi .index__step1___XHjas {\n  position: absolute;\n  top: 100px;\n  left: 19%;\n  text-align: center;\n  width: 100px;\n  height: 100px;\n  background-color: rgb(178, 116, 57);\n  border-radius: 50%;\n}\n\n.index__page1___2YmIi .index__step2___1mteh {\n  position: absolute;\n  bottom: 100px;\n  right: 19%;\n  text-align: center;\n  width: 100px;\n  height: 100px;\n  background-color: rgb(116, 178, 9);\n}\n.index__page2___2-Gki {\n  background-color: rgb(197, 181, 88);\n}\n\n.index__page3___2Fb1D {\n  background-color: #99CCCC;\n}\n.index__page1___2YmIi .index__step1___XHjas {\n  position: absolute;\n  top: 100px;\n  left: 19%;\n  text-align: center;\n  width: 100px;\n  height: 100px;\n  background-color: rgb(178, 116, 57);\n  border-radius: 50%;\n}\n\n.index__page1___2YmIi .index__step2___1mteh {\n  position: absolute;\n  bottom: 100px;\n  right: 19%;\n  text-align: center;\n  width: 100px;\n  height: 100px;\n  background-color: rgb(116, 178, 9);\n}\n\n.index__page4___3poOC {\n  background-color: rgb(204, 125, 51);\n}", ""]);

	// exports
	exports.locals = {
		"custom-slidePage": "index__custom-slidePage___2PbMu",
		"container": "index__container___1xKnV",
		"flash": "index__flash___1_26Y",
		"fadeIn": "index__fadeIn___3PnwS",
		"slide-page": "index__slide-page___BS2dA",
		"prev-page": "index__prev-page___1q7Dr",
		"next-page": "index__next-page___3RwcX",
		"pagination": "index__pagination___2NIVW",
		"middle": "index__middle___3AT6u",
		"tips": "index__tips___AqVy_",
		"active": "index__active___2_dK4",
		"add": "index__add___1jL8h",
		"remove": "index__remove___2EGwI",
		"page1": "index__page1___2YmIi",
		"step1": "index__step1___XHjas",
		"step2": "index__step2___1mteh",
		"page2": "index__page2___2-Gki",
		"page3": "index__page3___2Fb1D",
		"page4": "index__page4___3poOC"
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SlidePage = function (_Component) {
	  _inherits(SlidePage, _Component);

	  function SlidePage(props) {
	    _classCallCheck(this, SlidePage);

	    var _this = _possibleConstructorReturn(this, (SlidePage.__proto__ || Object.getPrototypeOf(SlidePage)).call(this, props));
	  ...
	  _createClass(SlidePage, [{
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('div', { className: (0, _classnames2.default)(_index2.default['slide-page'], this.props.className) }, _react2.default.createElement('div', null, this.props.children));
	    }
	  }]);
